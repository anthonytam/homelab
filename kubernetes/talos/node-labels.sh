...
kubectl label nodes worker01 egress-gw-vpnif=ens19
kubectl label nodes worker02 egress-gw-vpn=true
kubectl label nodes worker02 egress-gw-vpnif=ens19
kubectl label nodes worker03 egress-gw-vpn=true
kubectl label nodes worker03 egress-gw-vpnif=ens19
kubectl label nodes worker04 egress-gw-vpn=true
kubectl label nodes worker04 egress-gw-vpnif=ens19
kubectl label nodes worker05 egress-gw-vpn=true
kubectl label nodes worker05 egress-gw-vpnif=ens19
kubectl label nodes worker06 egress-gw-vpn=true
kubectl label nodes worker06 egress-gw-vpnif=eno1.42